...
Disclaimer: 
This code is untested and was never put into production. Use at your own risk.  Also, I had to make some modifications recently and no longer have a Linux environment to test, so expect some minor typos, etc.
